...
<div style="height:300px; width:600px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#CCC;">
     <form method="post" enctype="multipart/form-data">

   <table cellpadding="0" cellspacing="0" width="600px" height="300px" style="margin:auto; margin-top:100px;" >
	 
    <tr><td colspan="2" align="center" class="hddd"><br>Admin Login<br></td></tr>

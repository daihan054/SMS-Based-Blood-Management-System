...
<div style="height:auto; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#CCC;">
 ...
 <table cellpadding="20" cellspacing="20" width="1000px" height="200px"  style="margin:auto" >
   ...
   <tr bgcolor="#CCC"><td colspan="7" align="center" class="hddd"><br>View Contact List<br><br></td></tr>
 
   
 <tr style="background-color:#999" align="center" class="ff">
 
             <td class="ff" >Name</td><td >Email</td><td >Mobile Number</td><td >Details</td>
        </tr>
...
$s="select * from contacts";
	...
	{
				echo"<tr><td  style=' padding-left:50px'>$data[1]</td><td  style=' padding-left:10px'>$data[2]</td><td  style=' padding-left:20px'>$data[3]</td><td  style=' padding-left:30px'>$data[4]</td></tr>";
			}
			mysqli_close($cn);
			?>

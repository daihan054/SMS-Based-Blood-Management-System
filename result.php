...
<div class="wrap">
		<ul class="nav">
			...
			<li><a href="donorlist.php">View Donor lists</a></li>
...
<div style=" height:auto"> <br><br> <br><br>
  ...
  <table cellpadding="0" cellspacing="0" width="800px" height="350px" style="margin:auto; border:0px" class="tableborder">
        <tr><td  align="center" class="hddd"><br> Results<br><br></td></tr>
...
$cn=makeconnection();
	...
	$n=0;
?>
<tr><td><center><strong><br><br><br><br>
<?php
	if ($r=="0")
	{
		echo "Sorry No Donor found for this blood group"; 
	}
...
?>
  ...
  <tr><td  > <br>
            <table cellpadding="0" cellspacing="0" width="700px" height="150px" style="margin:auto; border:none;" class="tableborder">
                <tr><td width="250px"  align="center" style="vertical-align:middle">
